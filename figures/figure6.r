...
setwd("C:/Users/Mark/Desktop/figure_images/6")
...
######################################
## Fig. 6c. Dot blot quantification ##
######################################
blot_quant <- read_csv("R:/Basic_Sciences/CDB/HopeLab/Users/mbecker/figure_images/6/blot_quant.csv")
...
ggsave("C:/Users/Mark/Desktop/figure_images/6/fig6b.pdf", width = 1.3, height =2, units = "in")
timee <- 6
...
ggsave("C:/Users/Mark/Desktop/figure_images/6/revised/fig6c.pdf", width = 2.3, height = 2.2, units = "in")
...
ggplot(d7d8, aes(time+4, as.numeric(rate.of.change), colour=factor(donor), group = factor(sample.no))) +
  ...
  theme(axis.text = element_text(size=6), axis.title = element_text(size=8),
        ...
        legend.box.margin = margin(0, 0, 0, -10),
        legend.text = element_text(size=6), legend.title = element_text(size=6))
ggsave("C:/Users/Mark/Desktop/figure_images/6/revised/fig6d.pdf", width = 2.2, height = 2.2, units = "in")
...
################################################
## Fig 6sab. Continual2 rinse quantification. ##
################################################
...
ggplot(continual2, aes(time+3, as.numeric(norfreq), colour=factor(donor), group = factor(sample.no))) +
  ...
  geom_vline(xintercept = 153, linetype = 'dashed') +
  geom_line() +
  theme_bw() + 
  #stat_summary(aes(group = donor)) +
  #stat_smooth(method = "loess", span = 0.1, aes(group = donor)) +
  ...
  theme(axis.text = element_text(size=6), axis.title = element_text(size=8),
        ...
        legend.box.margin = margin(0, 0, 0, -10),
        legend.text = element_text(size=6), legend.title = element_text(size=6))
ggsave("C:/Users/Mark/Desktop/figure_images/6/revised/fig6s_a.pdf", width = 2.5, height = 2.2, units = "in")
...
ggplot(continual2, aes(time+3, as.numeric(rate.of.change), colour=factor(donor), group = factor(sample.no))) +
  ...
  geom_vline(xintercept = 151, linetype = 'dashed') +
  geom_line(alpha = 0.6) +
  theme_bw() + 
  #stat_summary(aes(group = donor)) +
  #stat_smooth(method = "loess", span = 0.1, aes(group = donor)) +
  ...
  theme(axis.text = element_text(size=6), axis.title = element_text(size=8),
        ...
        legend.box.margin = margin(0, 0, 0, -10),
        legend.text = element_text(size=6), legend.title = element_text(size=6))
ggsave("C:/Users/Mark/Desktop/figure_images/6/revised/fig6ds_b.pdf", width = 2.5, height = 2.2, units = "in")
