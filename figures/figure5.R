...
setwd("C:/Users/Mark/Desktop/figure_images/5")
...
print(p)
ggsave("C:/Users/Mark/Desktop/lastfig5/fig5aa.pdf", plot = p$plot, width = 4, height = 4, units = "in")
...
###############################
hunting <- read.csv("C:/Users/Mark/Desktop/hunting_ii.csv")
hunting <- hunting %>%
...
print(p)
 ggsave("C:/Users/Mark/Desktop/figure_images/5/revised/fig5c.pdf", plot = p$plot, width = 3.2, height = 2.4, units = "in")


summary(hunting$fov)
#######################################
# Supplement w/ survival time by day ##
#######################################
...
ggsave("C:/Users/Mark/Desktop/figure_images/5/revised/fig5d_test.pdf", width = 1.6, height = 1.4, units = "in")
...
##############################################################
fxns_bulk_fov <- fread('big_fxns_bulk_byvidpoint.csv')
fxns_bulk_culturepoint <- fread('big_fxns_bulk_byculturepoint.csv')
...
ggsave("revised/fig5e.pdf", width = 2, height = 2, units = "in")
...
################################
# i did this on adele in big_cbfs.R bc it was taking way too long on my desktop

#################################################################
## Fig. 5g. Fxn beating surface area by gfp category over time ##
#################################################################

fxns_labelled_fov <- fread('big_fxns_labelled_byvidpoint.csv')
fxns_labelled_culturepoint <- fread('big_fxns_labelled_byculturepoint.csv')
...
ggplot(subset(fxns_labelled_fov, hpi > 12), aes(x = hpi_category, color = factor(status, levels = level_order), y = ultraplaus)) +
  ...
  theme(axis.text = element_text(size = 6), 
        ...
        legend.title = element_text(size = 5),
        legend.position = "bottom")
ggsave("revised/fig5g.pdf", width = 3, height = 3, units = "in")
