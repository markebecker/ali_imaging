...
# loading in data
ciliako2_concatenated <- read_csv("D:/0_cbf/ko_cbfs/ciliako2_concatenated.csv")
ciliako44_concatenated <- read_csv("D:/0_cbf/ko_cbfs/ciliako44_concatenated.csv")
...
ggsave("C:/Users/Mark/Desktop/figure_images/4/fig4d.pdf", width = 1.6, height = 1.5, units = "in")
...
ggplot(dataa, aes(y=as.numeric(t0spy350)/as.numeric(t0spy0), x = conditionn, color = conditionn, shape = factor(donor))) +
  ...
  theme(axis.text = element_text(size=5, face = 'italic'), axis.title = element_text(size=6),
        ...
        legend.position = 'none')
ggsave("C:/Users/Mark/Desktop/figure_images/4/s9.pdf", width = 2, height = 2, units = "in")
...
ggsave("C:/Users/Mark/Desktop/figure_images/4/fig4e.pdf", width = 2, height = 1.5, units = "in")
...
ggsave("C:/Users/Mark/Desktop/figure_images/4/revised/fig4g_test.pdf", width = 3.3, height = 1.6, units = "in")
ggsave("C:/Users/Mark/Desktop/figure_images/4/revised/fig4g.pdf", width = 2.0, height = 1.6, units = "in")
...
ggsave("C:/Users/Mark/Desktop/figure_images/4/revised/rateofchange.pdf", width = 1.6, height = 1.6, units = "in")
...
ggplot(bigkodata, aes(condition, n.mm.2mean, shape = factor(donor.y), color = condition, group = condition)) +
  ...
  theme(axis.text = element_text(size=5, face = 'italic'), axis.title = element_text(size=6),
        ...
        #legend.position = c(0.8, 0.8),
        legend.position = 'none')
ggsave("C:/Users/Mark/Desktop/figure_images/4/fig4h.pdf", width = 1.5, height = 1.2, units = "in")
...
ggplot(bigkodata, aes(condition, good.peak.spots, shape = factor(donor.y), color = condition, group = condition)) +
  ...
  theme(axis.text = element_text(size=5, face = 'italic'), axis.title = element_text(size=6),
        ...
        #legend.position = c(0.8, 0.8),
        legend.position = 'none')
ggsave("C:/Users/Mark/Desktop/figure_images/4/s9_peak.pdf", width = 1.3, height = 1.2, units = "in")


ggplot(bigkodata, aes(condition, onedayspots, shape = factor(donor.y), color = condition, group = condition)) +
  labs(x = 'KO', y = 'Peak # GFP+ spots')+
  #scale_y_log10(limits = c(1e7, 3e9)) +
  #ylim(0, 40000) +
  theme_bw() +
  ...
  theme(axis.text = element_text(size=5, face = 'italic'), axis.title = element_text(size=6),
        ...
        #legend.position = c(0.8, 0.8),
        legend.position = 'none')
ggsave("C:/Users/Mark/Desktop/figure_images/4/s9_d1.pdf", width = 1.3, height = 1.2, units = "in")

ggplot(bigkodata, aes(condition, twodayspots, shape = factor(donor.y), color = condition, group = condition)) +
  labs(x = 'KO', y = 'Peak # GFP+ spots')+
  #scale_y_log10(limits = c(1e7, 3e9)) +
  #ylim(0, 40000) +
  theme_bw() +
  ...
  theme(axis.text = element_text(size=5, face = 'italic'), axis.title = element_text(size=6),
        ...
        #legend.position = c(0.8, 0.8),
        legend.position = 'none')
ggsave("C:/Users/Mark/Desktop/figure_images/4/s9_d2.pdf", width = 1.3, height = 1.2, units = "in")

ggplot(bigkodata, aes(condition, threedayspots, shape = factor(donor.y), color = condition, group = condition)) +
  labs(x = 'KO', y = 'Peak # GFP+ spots')+
  #scale_y_log10(limits = c(1e7, 3e9)) +
  #ylim(0, 40000) +
  theme_bw() +
  ...
  theme(axis.text = element_text(size=5, face = 'italic'), axis.title = element_text(size=6),
        ...
        #legend.position = c(0.8, 0.8),
        legend.position = 'none')
ggsave("C:/Users/Mark/Desktop/figure_images/4/s9_d3.pdf", width = 1.3, height = 1.2, units = "in")
...
ggplot(bigkodata_long, aes(x = condition, y = spots, shape = factor(donor.y), color = condition, group = condition)) +
  ...
  theme(axis.text = element_text(size = 5, face = 'italic'), 
        ...
        legend.position = 'none')
ggsave("C:/Users/Mark/Desktop/figure_images/4/s9_alldays.pdf", width = 6.8, height = 2.2, units = "in")

######################
#######################r
# things that are cute but not going in the final version.
